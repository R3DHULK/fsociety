...
while True:
    ip_add_entered = input("\n\033[92m [*] Please enter the ip address that you want to scan: ")
...
while True:
    ...
    print("\033[92m [*] Please enter the range of ports you want to scan in format: <int>-<int> (ex would be 60-120)")
    port_range = input("\033[92m [*] Enter port range: ")
